...
class AnalysesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create analysis" do
    assert_difference('Analysis.count') do
      post analyses_url, params: { analysis: { content: @analysis.content, rating: @analysis.rating, title: @analysis.title } }
    end
  ...
  test "should update analysis" do
    patch analysis_url(@analysis), params: { analysis: { content: @analysis.content, rating: @analysis.rating, title: @analysis.title } }
