...
class VideoGamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create video_game" do
    assert_difference('VideoGame.count') do
      post video_games_url, params: { video_game: { description: @video_game.description, editor: @video_game.editor, name: @video_game.name } }
    end
  ...
  test "should update video_game" do
    patch video_game_url(@video_game), params: { video_game: { description: @video_game.description, editor: @video_game.editor, name: @video_game.name } }
